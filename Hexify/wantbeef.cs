...
namespace iTalk
{
    ...
    public class iTalk_ControlBox : Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.Clear(BackColor);
            LinearGradientBrush xMinimizeGradient = new LinearGradientBrush(this.MinimizeRect, Color.FromArgb(0, 191, 255), Color.FromArgb(0, 191, 255), 90f);
            G.FillPath(xMinimizeGradient, GP_MinimizeRect);
            G.DrawPath(new Pen(Color.FromArgb(0, 177, 237)), GP_MinimizeRect);
            ...
            LinearGradientBrush xCloseGradient = new LinearGradientBrush(CloseRect, Color.FromArgb(0, 191, 255), Color.FromArgb(0, 191, 255), 90);
            G.FillPath(xCloseGradient, GP_CloseRect);
            G.DrawPath(new Pen(Color.FromArgb(0, 177, 237)), GP_CloseRect);
    ...
    class iTalk_CheckBox : Control
    {
        ...
        public iTalk_CheckBox()
        {
            ...
            BackColor = Color.FromArgb(32, 180, 247);
            DoubleBuffered = true;
            Font = new Font("Segoe UI", 10);
